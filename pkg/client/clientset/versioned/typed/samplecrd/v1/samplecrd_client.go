...
import (
	...
	"github.com/tonyshanc/sample-operator-v1/pkg/client/clientset/versioned/scheme"
...
func (c *SamplecrdV1Client) Cars(namespace string) CarInterface {
	return newCars(c, namespace)
}
